    ...
    <Box>
      <Grid container spacing={2} mt={isMobile ? 5 : 0}>
        <Grid item md={4} xs={12} align="center" mt={isMobile ? 0 : 10}>
          ...
          <Typography p={1}>Stay updated with our products</Typography>
          <Button
        ...
        <Grid item md={6} xs={12} align="left" mt={isMobile ? 0 : 10}>
          <Box display={"flex"} flexDirection={"column"} height={"96%"}>
            <Box px={isMobile ? 1 : 0}>
              ...
              <Typography fontSize={25} mt={2}>
                Aren't you fed up sharing your revenues with Visa and
                Mastercard?
              </Typography>
            </Box>
            <Box flexGrow={1}></Box>
        ...
        <Grid item xs={12} align="left">
          <Box px={isMobile ? 1 : 5}>
            <Typography fontSize={20}>
              What is your business about, we will help you!
            </Typography>
            <TextField
              id="b_msg"
              label="Your message"
